...
zokou({
  ...
  try {
    ...
    if (_0x5a2825 && _0x5a2825.length > 0x0) {
      ...
      const _0x4727f9 = await fetch("https://gifted-apis-third-30b2fdbb9819.herokuapp.com/api/download/ytmp3?url=" + encodeURIComponent(_0x50cb1f) + "&apikey=" + "giftedtechk");
...
zokou({
  ...
  try {
    ...
    if (_0x3f4e2c && _0x3f4e2c.length > 0x0) {
      ...
      const _0xfef402 = await fetch("https://gifted-apis-third-30b2fdbb9819.herokuapp.com/api/download/ytmp3?url=" + encodeURIComponent(_0x13523a) + "&apikey=" + "giftedtechk");
