...
zokou({
  ...
  if (s.HEROKU_APP_NAME == null || s.HEROKU_API_KEY == null) {
    _0x101d12("Please fill in the HEROKU_APP_NAME and HEROKU_API_KEY environment variables");
    return;
  }
  ;
...
zokou({
  ...
  ;
  if (s.HEROKU_APP_NAME == null || s.HEROKU_API_KEY == null) {
    _0x5af953("Please fill in the HEROKU_APP_NAME and HEROKU_API_KEY environment variables");
    return;
  }
  ;
...
zokou({
  ...
  ;
  if (s.HEROKU_APP_NAME == null || s.HEROKU_API_KEY == null) {
    _0x191ee9("Please fill in the HEROKU_APP_NAME and HEROKU_API_KEY environment variables");
    return;
  }
  ;
  if (!_0x23c562[0x0]) {
...
function changevars(_0x272aba, _0x555599) {
  zokou({
    ...
    ;
    if (s.HEROKU_APP_NAME == null || s.HEROKU_API_KEY == null) {
      _0x31e1ae("Please fill in the HEROKU_APP_NAME and HEROKU_API_KEY environment variables");
      return;
    }
    ;
    if (!_0x3541b7[0x0]) {
