...
const date = moment().format('DD/MM/YYYY');
  ...
  *𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 IS ONLINE WITH [${cm.length}0] COMMANDS*
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *ZEZE*, déveloper 𝘡𝘌𝘡𝘌47 𝘛𝘌𝘊𝘏" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
